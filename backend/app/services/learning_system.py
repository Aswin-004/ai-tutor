"""LearningSystem: the AI tutoring orchestrator.

Persona building, adaptive RAG-augmented chat (including agentic
tool-calling mode), quiz generation, and roadmap generation.
"""
...
__all__ = ["LearningSystem", "TutorMode"]
